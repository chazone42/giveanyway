    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img class="d-block" src="logo/logojul2rgb.png" height="60">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('enrollform') }}">{{ __('ลงทะเบียน')}}</a>
                    </li>
...
<footer class=" pt-4">
    <div class="row shadow">
        <div class="footer-left pt-4 pr-5 pl-5 pb-5 w-50 bg-white ">
            <img class="d-block responsive" src="logo/logojul2rgb.png">
        </div>
